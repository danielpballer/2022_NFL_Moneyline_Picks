...
inst.picks = list(week_1, week_2, week_3, week_4, week_5, week_6, week_7, week_8, week_9, week_10, week_11,
                  week_12) #add in the additional weeks
...
```{r Calculting instructor winnings based on moneyline odds, eval=FALSE, include=FALSE}
#turned off code chunk for the 2022 season
...
```{r Creating instructor winnings table, eval=FALSE, include=FALSE}
#turned off code chunk for the 2022 season
...
```{r Instructor winnings plot, eval=FALSE, include=FALSE}
#turned off code chunk for the 2022 season
