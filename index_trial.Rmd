...
####################UPDATE THESE###############################
inst.picks = list(week_1, week_2, week_3, week_4, week_5) #add in the additional weeks
odds = rbind(odds_wk1, odds_wk2, odds_wk3, odds_wk4, odds_wk5) #add in the additional weeks
####################END OF UPDATE##############################
